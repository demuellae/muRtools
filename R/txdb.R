...
getTxDb.gencode <- function(name){
	...
	fileTab <- data.frame(
		name=c("gencode.v29", "gencode.v27", "gencode.v19", "gencode.vM21", "gencode.vM16", "gencode.vM1"),
		version=c("29", "27", "19", "M21", "M16", "M1"),
		fileURL=c(
		...
		organism = c("Homo sapiens", "Homo sapiens", "Homo sapiens", "Mus musculus", "Mus musculus", "Mus musculus"),

		genomeAss=c("hg38", "hg38", "hg19", "mm10", "mm10", "mm9"),
