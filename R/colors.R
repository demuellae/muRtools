...
#' @examples
#' plot.new()
#' gradient.rect(0,0,1,1,col=colpal.mu.cat,nslices=length(colpal.mu.cat),gradient="x",border=NA)
...
#' @examples
#' plot.new()
#' gradient.rect(0,0,1,1,col=colpal.corpid,nslices=length(colpal.corpid),gradient="x",border=NA)
colpal.corpid <- c(
